...
puts "In Evanston, it is currently #{forecast["currently"]["temperature"]} and #{forecast["currently"]["summary"]}."
puts "A high temperature of #{forecast["daily"]["data"][0]["temperatureHigh"]}."
